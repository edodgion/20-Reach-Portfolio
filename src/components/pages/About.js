    ...
    <div className="container">
      <div className="mx-2 mt-5 p-2 aboutMe">
        ...
        <p>
          ...
          my skills in full stack web development. Throughout these next few
          months I'm very excited to learn various skill sets so that I may hone
          them into something that will help me evolve into a flourishing
